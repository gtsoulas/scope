...
\ex.\label{intro10}\a.XP {\dots} $\langle$\textst{XP}$\rangle$ $\qquad$ (moved construction)
    \b.$\langle$\textst{XP}$\rangle$ {\dots} XP $\qquad$ (in-situ construction)
